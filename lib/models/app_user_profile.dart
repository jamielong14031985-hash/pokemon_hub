...
class AppUserProfile {
  ...
  bool get hasProfileImage => profileImageBase64 != null && profileImageBase64!.trim().isNotEmpty;
  ...
  Map<String, dynamic> toJson() => {
        ...
        if (hasProfileImage && !FirebaseImageStorageService.isRemoteRef(profileImageBase64))
  ...
  factory AppUserProfile.fromMap(Map<String, dynamic> json) {
    return AppUserProfile(
      ...
      profileImageBase64: _firstNonEmptyString([
